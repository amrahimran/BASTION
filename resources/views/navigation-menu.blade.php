<nav x-data="{ open: false }" class="bg-[#0b1d2a] border-b border-[#122c3f]">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#0b1d2a]">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/bastionlogo.png') }}" alt="Bastion Logo" class="h-12 w-auto mt-1">
                    </a>
                </div>
